...
* Температурная программа - послежовательность, состоящая из температурных пауз. Каждой температурной программе соответсвует определенное количество температурных пауз. 
